...
- generic [ref=e3]:
  ...
  - main [ref=e167]:
    ...
    - generic "已打开页面" [ref=e180]:
      - link "全部功能" [ref=e181] [cursor=pointer]:
        - /url: /operations
      - link "显示设置" [ref=e182] [cursor=pointer]:
        - /url: /operations/settings/display
      - generic [ref=e183]:
        - link "宝贝水印" [ref=e184] [cursor=pointer]:
          - /url: /operations/product-editor/product-editor-03
        - button "关闭 宝贝水印" [ref=e185] [cursor=pointer]
    - generic [ref=e189]:
      - paragraph [ref=e190]: 宝贝水印
      - generic [ref=e191]:
        - generic [ref=e192]:
          - heading "宝贝水印" [level=2] [ref=e193]
          - paragraph [ref=e194]: "产品编辑 · #/set/system/watermark"
        - generic [ref=e195]:
          - button "重置" [ref=e196] [cursor=pointer]
          - button "保存配置" [ref=e197] [cursor=pointer]
          - button "连接后端中" [disabled] [ref=e198]
      - generic [ref=e201]:
        - link "运营目录" [ref=e202] [cursor=pointer]:
          - /url: /operations
        - generic [ref=e205]: 内容生产
        - strong [ref=e208]: 产品编辑
        - generic [ref=e209]: CONNECTING
        - combobox "切换当前模块功能" [ref=e210]:
          - option "012 · 普通宝贝"
          - option "013 · 拍卖宝贝"
          ...
          - option "021 · 视频操作教程"
      - generic [ref=e211]:
        - heading "宝贝水印" [level=3] [ref=e213]
        - generic [ref=e214]:
          - generic [ref=e215]:
            - generic [ref=e216]: 水印模板
            - combobox "水印模板" [ref=e217]:
              - option "品牌角标" [selected]
              - option "账号标识"
              - option "售后说明"
          - generic [ref=e218]:
            - generic [ref=e219]: 水印位置
            - combobox "水印位置" [ref=e220]:
              - option "右下角" [selected]
              - option "左下角"
              - option "居中"
          - generic [ref=e221]:
            - generic [ref=e222]: 不透明度（%）
            - spinbutton "不透明度（%）" [ref=e223]: "72"
          - generic [ref=e224]:
            - generic [ref=e225]: 仅生成预览
            - generic [ref=e226]:
              - checkbox "仅生成预览 已开启" [checked] [ref=e227]
              - generic [ref=e228]: 已开启
        - generic [ref=e229]:
          - button "brand-cover-01.jpg 图片 · 1080×1440 · 引用 12 次" [ref=e230] [cursor=pointer]:
            - generic [ref=e237]:
              - strong [ref=e238]: brand-cover-01.jpg
              - generic [ref=e239]: 图片 · 1080×1440 · 引用 12 次
          - button "product-demo-03.mp4 视频 · 00:24 · 引用 8 次" [ref=e240] [cursor=pointer]:
            - generic [ref=e247]:
              - strong [ref=e248]: product-demo-03.mp4
              - generic [ref=e249]: 视频 · 00:24 · 引用 8 次
          - button "service-intro.wav 音频 · 00:31 · 引用 3 次" [ref=e250] [cursor=pointer]:
            - generic [ref=e258]:
              - strong [ref=e259]: service-intro.wav
              - generic [ref=e260]: 音频 · 00:31 · 引用 3 次
          - button "authorized-address-pool 地址池 · 18 条 · revision 7" [ref=e261] [cursor=pointer]:
            - generic [ref=e265]:
              - strong [ref=e266]: authorized-address-pool
              - generic [ref=e267]: 地址池 · 18 条 · revision 7
        - button "导出索引" [ref=e269] [cursor=pointer]
        - generic [ref=e273]:
          - textbox "筛选当前功能记录" [ref=e278]:
            - /placeholder: 名称、设备、分组、负责人
          - combobox "设备筛选" [ref=e279]:
            - option "全部设备" [selected]
            - option "杭州-内容-023"
            - option "上海-内容-014"
            - option "北京-实验-008"
            - option "广州-内容-031"
          - combobox "状态筛选" [ref=e280]:
            ...
            - option "BLOCKED"
          - button "导出结果" [ref=e281] [cursor=pointer]
          - generic [ref=e285]: 0 条
        - generic [ref=e286]:
          - strong [ref=e291]: 已选择 0 项
          - button "取消选择" [ref=e292] [cursor=pointer]
          - button "连接后端中" [disabled] [ref=e293]
        - table [ref=e295]:
          - rowgroup [ref=e296]:
            - row [ref=e297]:
              - columnheader [ref=e298]:
                - checkbox "选择当前筛选全部记录" [ref=e299]
              - columnheader "对象" [ref=e300]
              - columnheader "分组" [ref=e301]
              - columnheader "设备" [ref=e302]
              - columnheader "负责人" [ref=e303]
              - columnheader "状态" [ref=e304]
              - columnheader "更新时间" [ref=e305]
              - columnheader "操作" [ref=e306]
          - rowgroup [ref=e307]:
            - row [ref=e308]:
              - cell "没有符合筛选条件的记录" [ref=e309]
      - generic [ref=e318]:
        - strong [ref=e319]: 可模拟 · 正在连接 Control API
        - paragraph [ref=e320]: Control API 不可用，页面已 fail closed；不会创建 Mock 回执或生产任务。
      - generic [ref=e321]:
        - generic [ref=e322]:
          - generic [ref=e323]:
            - heading "竞品页面依据" [level=3] [ref=e324]
            - paragraph [ref=e325]: PDF 第 21 页 · 产品编辑 › 宝贝水印
          - code [ref=e326]: "#/set/system/watermark"
        - generic [ref=e327]:
          - paragraph [ref=e328]: 选择水印规则、定位方式和预览输出，提交前只生成派生预览。
          - list "页面工作流程" [ref=e329]:
            - listitem [ref=e330]:
              - generic [ref=e331]: "1"
              - strong [ref=e332]: 选择图片
            - listitem [ref=e333]:
              - generic [ref=e334]: "2"
              - strong [ref=e335]: 套用水印模板
            - listitem [ref=e336]:
              - generic [ref=e337]: "3"
              - strong [ref=e338]: 检查不同尺寸预览
            - listitem [ref=e339]:
              - generic [ref=e340]: "4"
              - strong [ref=e341]: 保存规则版本
      - generic [ref=e342]: 页面规格 014
```
